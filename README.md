...
1. [Introduction to Node.js](./Chapter%2001%20-%20Intro%20to%20NodeJS/01_Intro-to-nodejs.md)
    ...
    - [Why Node.js was created](./Chapter%2001%20-%20Intro%20to%20NodeJS/01_Intro-to-nodejs.md#why-nodejs-was-created)
...
4. [module.exports & require](./Chapter%2004%20-%20module.export%20&%20require/04_module.export-and-require.md)
    ...
    - [Why are modules required](./Chapter%2004%20-%20module.export%20&%20require/04_module.export-and-require.md#why-are-modules-required)
...
5. [Diving into the Node.js github repo](./Chapter%2005%20-%20Diving%20into%20the%20NodeJS%20github%20repo/05_diving-into-the-nodejs-github-repo.md)
    ...
    - [More about `module` argument of module wrapper](./Chapter%2005%20-%20Diving%20into%20the%20NodeJS%20github%20repo/05_diving-into-the-nodejs-github-repo.md#more-about-module-argument-of-module-wrapper)
    - [More about `exports` argument of module wrapper](./Chapter%2005%20-%20Diving%20into%20the%20NodeJS%20github%20repo/05_diving-into-the-nodejs-github-repo.md#more-about-exports-argument-of-module-wrapper)
    - [Other arguments of module wrapper](./Chapter%2005%20-%20Diving%20into%20the%20NodeJS%20github%20repo/05_diving-into-the-nodejs-github-repo.md#other-arguments-of-module-wrapper)
...
6. [libuv & async IO](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md)
    ...
    - [How Javascript shows Asynchronous behaviour?](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#how-javascript-shows-asynchronous-behaviour)
    - [Simple workflow of handling async tasks](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#simple-workflow-of-handling-async-tasks)
    - [Simple Async code execution](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#simple-async-code-execution)
    - [What is libuv library](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#what-is-libuv-library)
    - [What is libuv's thread pool?](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#what-is-libuvs-thread-pool)
    - [Why the term "Asynchronous I/O"](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#why-the-term-asynchronous-io)
    - [Why the term "Non-Blocking I/O"](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#why-the-term-non-blocking-io)
    - [What is callback queue (task queue)?](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#what-is-callback-queue-task-queue)
    - [Callback queue vs Microtask queue](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#callback-queue-vs-microtask-queue)
    - [Concurrency Vs Parallelism](./Chapter%2006%20-%20libuv%20&%20async%20IO/06_libuv-and-async-io.md#concurrency-vs-parallelism)
